                ...
                <div class="navbar align-self-center d-flex">
                    <div class="d-lg-none flex-sm-fill mt-3 mb-4 col-7 col-sm-auto pr-3">
                        <div class="input-group">
                            <input type="text" class="form-control" id="inputMobileSearch" name="searchQuaery" placeholder="Search product by name, brand, category ...">
                    ...
                    <?php if (isset($_SESSION['sessionData']) && isset($_SESSION['sessionData']['userId'])): ?>
                        <a class="nav-icon position-relative text-decoration-none" href="{{ url('/userController/myCart') }}">
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end mt-4" aria-labelledby="profileDropdown">
                                <?php if ($_SESSION['sessionData']['role'] === 'customer'): ?>
                                    <li><a class="dropdown-item" href="{(url('/userController/dashboard') }}">Dashboard</a></li>
                                <?php else: ?>
                                    <li><a class="dropdown-item" href="{(url('/adminController/dashboard') }}">Dashboard</a></li>
                                <?php endif ?>
                                <li><a class="dropdown-item" href="{(url('/pageController/logout') }}">Logout</a></li>
                            </ul>
                        </div>
                    <?php else: ?>
