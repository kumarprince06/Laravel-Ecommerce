...
<section class="bg-success py-5">
    <div class="container">
        <div class="row align-items-center py-5">
            ...
            <div class="col-md-4">
                <img src="{{ asset('images/about.png') }}" class="img-fluid" alt="About Hero">
            </div>
        </div>
    </div>
</section>
                        ...
                        <div class="carousel slide carousel-multi-item pt-2 pt-md-0" id="templatemo-slide-brand" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                <div class="carousel-item active">
                                    <div class="row">
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/samsung.png')}}" alt="Samsung Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/motorola.png')}}" alt="Motorola Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/redmi.png')}}" alt="Redmi Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/realme.png')}}" alt="Realme Logo"></a>
                                        </div>
                                    </div>
                                </div>
                                <!--End First slide-->
                                ...
                                <div class="carousel-item">
                                    <div class="row">
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/apple.png')}}" alt="Apple Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/hp.png')}}" alt="HP Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/dell.png')}}" alt="Dell Logo"></a>
                                        </div>
                                        <div class="col-3 p-md-5">
                                            <a href="#"><img class="img-fluid brand-img" src="{{ asset('images/lenovo.png')}}" alt="Lenovo Logo"></a>
                                        </div>
                                    </div>
                                </div>
                                <!--End Second slide-->
